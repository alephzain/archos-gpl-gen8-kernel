...
int __init panel_a35_init(struct omap_dss_device *disp_data)
{
	...
	if ( machine_is_archos_a35() && (hardware_rev < 6) ) {
		mt_a35_panel.ctrl.pixel_size = 18;
		mt_a35_panel.phy.rfbi.data_lines = 9;
		mt_a35_panel.phy.rfbi.ext_te = 0;
	}
